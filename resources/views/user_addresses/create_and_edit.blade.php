@extends('layouts.app')
@section('title', ($user_address->id ? '修改' : '新增') . '收货地址')
            ...
            <div class="card">
                ...
                <!-- 输出后端报错结束 -->
                    ...
                    <user-addresses-create-and-edit inline-template>
                        ...
                        {{ csrf_field() }}
                        <!-- 注意这里多了 @change -->
                            <select-district :init-value="{{ json_encode([old('province', $user_address->province), old('city', $user_address->city), old('district', $user_address->district)]) }}" @change="onDistrictChanged" inline-template>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="address" value="{{ old('address', $user_address->address) }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label text-md-right col-sm-2">邮编</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="zip" value="{{ old('zip', $user_address->zip) }}">
                                </div>
                            </div>
                            <div class="form-group row">
